...
export declare class ColumnBase {
     ...
     * For more information on the prerequisites, setup, and
     * limitations of the feature, refer to the article on
     * [setting up the locked columns]({% slug locked_columns_grid %}) of the Grid.
     *
     * @default false
     *
     * @example
     ...
     * (see the [basic usage example]({% slug hidden_columns_grid %}#toc-using-built-in-options)).
     *
     * @default false
     */
    hidden: boolean;
