...
var SplitterBarComponent = /** @class */ (function () {
    ...
    SplitterBarComponent.prototype.ngOnInit = function () {
        ...
        this.subscriptions.add(this.zone.runOutsideAngular(function () {
            var state;
            _this.draggable.kendo.press.pipe(tap_1.tap(stopPropagation), filter_1.filter(function () { return _this.splitter.isDraggable(_this.index); }), tap_1.tap(function () { return state = _this.splitter.dragState(_this.index); }), tap_1.tap(function () { return toggleContentOverlay(_this.splitter, _this.index, true); }), switchMap_1.switchMap(preventOnDblClick(_this.draggable.kendo.release)), switchMap_1.switchMap(createMoveStream(_this.draggable))).subscribe(function (_a) {
    ...
    SplitterBarComponent.propDecorators = {
        ...
        'order': [{ type: core_1.HostBinding, args: ['style.order',] },],
