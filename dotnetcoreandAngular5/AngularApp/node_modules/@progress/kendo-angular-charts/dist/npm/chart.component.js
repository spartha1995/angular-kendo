...
var ChartComponent = /** @class */ (function (_super) {
    ...
    ChartComponent.prototype.refreshWait = function () {
        var _this = this;
        this.ngZone.runOutsideAngular(function () {
            _this.subscription = _this.configurationService.onChange$.pipe(combineLatest_1.combineLatest(_this.themeService.onChange$, function (options, theme) {
                _this.options = options;
                _this.theme = theme;
            }), auditTime_1.auditTime(configuration_service_1.THROTTLE_MS))
                .subscribe(function () {
                _this.refresh();
            });
        });
    ...
    ChartComponent.propDecorators = {
        ...
        'dir': [{ type: core_2.HostBinding, args: ['attr.dir',] },],
