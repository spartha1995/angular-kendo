...
export class ChartComponent extends ChartComponentGenerated {
    constructor(configurationService, themeService, element, intl, ngZone, instanceEventService, changeDetector, renderer, rtl) {
    ...
    refreshWait() {
        this.ngZone.runOutsideAngular(() => {
            this.subscription = this.configurationService.onChange$.pipe(combineLatest(this.themeService.onChange$, (options, theme) => {
