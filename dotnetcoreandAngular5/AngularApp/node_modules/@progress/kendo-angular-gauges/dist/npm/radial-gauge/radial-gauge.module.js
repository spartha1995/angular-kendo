...
/**
 * A [module](https://angular.io/docs/ts/latest/guide/ngmodule.html) that includes the Radial Gauge component and its directives.
 *
 ...
 * that will use the Radial Gauge component.
 *
 * @example
 * ```ts-no-run
...
var RadialGaugeModule = /** @class */ (function () {
    ...
    /** @nocollapse */
    RadialGaugeModule.ctorParameters = function () { return []; };
