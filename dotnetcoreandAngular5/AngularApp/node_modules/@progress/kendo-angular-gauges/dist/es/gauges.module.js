...
/**
 * A [module](https://angular.io/docs/ts/latest/guide/ngmodule.html) that includes all Gauge components and directives.
 *
...
var GaugesModule = /** @class */ (function () {
    ...
    /** @nocollapse */
    GaugesModule.ctorParameters = function () { return []; };
    return GaugesModule;
}());
export { GaugesModule };
